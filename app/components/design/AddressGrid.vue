      ...
      >
        ...
        >
          <div
            ...
            :class="cell.fixture
              ? (dragFixture?.id === cell.fixture.id && didDrag ? 'cursor-grabbing opacity-40' : 'cursor-grab')
              : ''"
          ...
          >
            <!-- Fixture background (inset creates visual gap between fixtures) -->
            <div
              v-if="cell.fixture"
              class="absolute z-0"
              :class="[
            ...
            <!-- Selection border outline (around the entire fixture block as one unit) -->
            <div
            ...
            <!-- Label at start of each row segment -->
            <div
